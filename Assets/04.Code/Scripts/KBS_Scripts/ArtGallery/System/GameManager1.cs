...
public class GameManager1 : SimulationBehaviour
{
    ...
    {
        var op = RunnerController.Runner.SpawnAsync(playerPrefab, new Vector3(-55.5f, 1.5f, -95f), Quaternion.identity, null);
